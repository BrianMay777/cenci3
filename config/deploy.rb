...
set :scm,             :git
set :repository,      "git@github.com:bramswenson/cenci3.git"
...
role :db,     "dev01.cenciyo.com", :primary => true
...
namespace :deploy do
  ...
  task :restart, :except => { :no_release => true } do
    run "kill -s USR2 `cat /tmp/unicorn_server_cenci.pid`"
  end
  ...
  task :stop, :except => { :no_release => true } do
    run "kill -s QUIT `cat /tmp/unicorn_server_cenci.pid`"
  end
